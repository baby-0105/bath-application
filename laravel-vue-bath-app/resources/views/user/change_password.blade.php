    ...
    <div class="user-form change-password">
        ...
        <form class="form" method="POST" action="">
            ...
            <div class="list">
                ...
                <input class="field" type="password" name="password" value="{{ old('password') }}">
            </div>
            @error('new-password')
                <p class="error">{{ $message }}</p>
            @enderror
            <div class="list">
                ...
                <input class="field" type="password" name="new-password" value="{{ old('new-password') }}">
            </div>
            ...
            <div class="list">
                ...
                <input class="field" type="password" name="new-password-confirmation" value="{{ old('new-password-confirmation') }}">
            </div>
