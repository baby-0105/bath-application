    ...
    <div class="user-form change-email">
        ...
        <form class="form" method="POST" action="">
            ...
            <div class="list">
                ...
                <input class="input" type="text" name="new-email" value="{{ old('new-email') }}">
            </div>
            ...
            <div class="list">
                ...
                <input class="input" type="text" name="new-email-confirmation" value="{{ old('new-email-confirmation') }}">
            </div>
