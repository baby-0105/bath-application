...
@section('content')
    <div class="privacy-policy">
        ...
        <div class="terms">
            <div class="1">
                <h2 class="terms-title">第1条（個人情報）</h2>
                <p>
            ...
            <div class="2">
                <h2 class="terms-title">第2条（個人情報の収集方法）</h2>
                <p>
            ...
            <div class="3">
                <h2 class="terms-title">第3条（個人情報を収集・利用する目的）</h2>
                <p>
            ...
            <div class="4">
                <h2 class="terms-title">第4条（利用目的の変更）</h2>
                <p>
            ...
            <div class="5">
                <h2 class="terms-title">第5条（個人情報の第三者提供）</h2>
                <p>
            ...
            <div class="6">
                <h2 class="terms-title">第6条（個人情報の開示）</h2>
                <p>
            ...
            <div class="7">
                <h2 class="terms-title">第7条（個人情報の訂正および削除）</h2>
                <p>
            ...
            <div class="8">
                <h2 class="terms-title">第8条（個人情報の利用停止等）</h2>
                <p>
            ...
            <div class="9">
                <h2 class="terms-title">第9条（プライバシーポリシーの変更）</h2>
                <p>
